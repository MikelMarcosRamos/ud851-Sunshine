...
//  COMPLETED (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    ...
    private TextView mTvWeatherHighTemperature;
    private TextView mTvWeatherLowTemperature;
...
//      COMPLETED (13) Find each of the TextViews by ID
        mTvWeatherDate = (TextView)findViewById(R.id.tv_weather_date);
        mTvWeatherDescription = (TextView)findViewById(R.id.tv_weather_description);
        mTvWeatherHighTemperature = (TextView)findViewById(R.id.tv_weather_high_temperature);
        mTvWeatherLowTemperature = (TextView)findViewById(R.id.tv_weather_low_temperature);
        mTvWeatherHumidity = (TextView)findViewById(R.id.tv_weather_humidity);
        mTvWeatherWind = (TextView)findViewById(R.id.tv_weather_wind);
        mTvWeatherPressure = (TextView)findViewById(R.id.tv_weather_pressure);
...
//      COMPLETED (26) Display a readable data string
        ...
        mTvWeatherDate.setText(dateText);

//      COMPLETED (27) Display the weather description (using SunshineWeatherUtils)
        mTvWeatherDescription.setText(SunshineWeatherUtils.getStringForWeatherCondition(this,data.getInt(INDEX_WEATHER_CONDITION_ID)));
//      COMPLETED (28) Display the high temperature
        double highInCelsius = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String highString = SunshineWeatherUtils.formatTemperature(this, highInCelsius);
        mTvWeatherHighTemperature.setText(highString);

//      COMPLETED (29) Display the low temperature
        double lowInCelsius = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowString = SunshineWeatherUtils.formatTemperature(this, lowInCelsius);
        mTvWeatherLowTemperature.setText(lowString);

//      COMPLETED (30) Display the humidity
        float humidity = data.getFloat(INDEX_WEATHER_HUMIDITY);
        mTvWeatherHumidity.setText(getString(R.string.format_humidity, humidity));

//      COMPLETED (31) Display the wind speed and direction
        float windSpeed = data.getFloat(INDEX_WEATHER_WIND_SPEED);
        float windDirection = data.getFloat(INDEX_WEATHER_DEGREES);
        String windString = SunshineWeatherUtils.getFormattedWind(this, windSpeed, windDirection);
        mTvWeatherWind.setText(windString);

//      COMPLETED (32) Display the pressure
        float pressure = data.getFloat(INDEX_WEATHER_PRESSURE);
        mTvWeatherPressure.setText(getString(R.string.format_pressure, pressure));

//      COMPLETED (33) Store a forecast summary in mForecastSummary
        mForecastSummary = String.format("%s - %s - %s/%s",
                dateText, mTvWeatherDescription.getText().toString(), highString, lowString);
    }
