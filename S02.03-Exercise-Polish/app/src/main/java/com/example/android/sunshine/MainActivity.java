...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mMensajeError;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMensajeError = (TextView) findViewById(R.id.mensaje_error);

        // COMPLETED (17) Find the ProgressBar using findViewById
        pbCargando = (ProgressBar) findViewById(R.id.cargando);
    ...
    private void showWeatherDataView() {
        mMensajeError.setVisibility(View.INVISIBLE);
    ...
    private void showErrorMessage() {
        mMensajeError.setVisibility(View.VISIBLE);
